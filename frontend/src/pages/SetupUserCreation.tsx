      ...
      <div className="setup-card">
        ...
        <form onSubmit={handleFormSubmission}>
          <label htmlFor="user-creation-username">
            ...
            <ErrorText
              show={
                (submitted || (touched?.username && !!username?.value.length)) && !!errors?.username
              }
          ...
          <label htmlFor="user-creation-password">
            ...
            <ErrorText
              show={
                (submitted || (touched?.password && !!password?.value.length)) && !!errors?.password
              }
          ...
          <label htmlFor="user-creation-password-verification">
            ...
            <input
              ...
              className={classNames({
                'input-error':
                  (submitted || (touched?.passwordVerify && !!passwordVerify?.value.length)) &&
